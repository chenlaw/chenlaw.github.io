...
window.waifuSettings = {
  // ---------- 后端接口 ----------
  resourcePath: "/live2d/widget/", // 自托管资源根目录
  waifuApi: "/live2d/api", // 自托管静态 API
  ...
  showSwitchModel: false,      // 显示模型切换按钮（自托管仅一个模型，隐藏）
  showSwitchTextures: false,   // 显示材质切换按钮（静态托管不支持换装，隐藏）
  ...
  waifuDraggable: "unlimited",  // 可选 "disable"(禁用), "axis-x"(只能水平拖拽), "unlimited"(自由拖拽)
  waifuDraggableRevert: false, // 松开鼠标后是否平滑还原拖拽位置
